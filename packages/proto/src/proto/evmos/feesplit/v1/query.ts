...
export namespace evmos.feesplit.v1 {
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            FeeSplits: {
                ...
                requestSerialize: (message: QueryFeeSplitsRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryFeeSplitsRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryFeeSplitsResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryFeeSplitsResponse.deserialize(new Uint8Array(bytes))
            },
            FeeSplit: {
                path: "/evmos.feesplit.v1.Query/FeeSplit",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryFeeSplitRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryFeeSplitRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryFeeSplitResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryFeeSplitResponse.deserialize(new Uint8Array(bytes))
            },
            Params: {
            ...
            DeployerFeeSplits: {
                ...
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryDeployerFeeSplitsRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryDeployerFeeSplitsRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryDeployerFeeSplitsResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryDeployerFeeSplitsResponse.deserialize(new Uint8Array(bytes))
            },
            WithdrawerFeeSplits: {
                path: "/evmos.feesplit.v1.Query/WithdrawerFeeSplits",
                requestStream: false,
                responseStream: false,
                requestSerialize: (message: QueryWithdrawerFeeSplitsRequest) => Buffer.from(message.serialize()),
                requestDeserialize: (bytes: Buffer) => QueryWithdrawerFeeSplitsRequest.deserialize(new Uint8Array(bytes)),
                responseSerialize: (message: QueryWithdrawerFeeSplitsResponse) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => QueryWithdrawerFeeSplitsResponse.deserialize(new Uint8Array(bytes))
            }
        };
    ...
    export class QueryClient extends grpc_1.makeGenericClientConstructor(UnimplementedQueryService.definition, "Query", {}) {
        ...
        FeeSplits: GrpcUnaryServiceInterface<QueryFeeSplitsRequest, QueryFeeSplitsResponse> = (message: QueryFeeSplitsRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryFeeSplitsResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryFeeSplitsResponse>, callback?: grpc_1.requestCallback<QueryFeeSplitsResponse>): grpc_1.ClientUnaryCall => {
            return super.FeeSplits(message, metadata, options, callback);
        };
        FeeSplit: GrpcUnaryServiceInterface<QueryFeeSplitRequest, QueryFeeSplitResponse> = (message: QueryFeeSplitRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryFeeSplitResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryFeeSplitResponse>, callback?: grpc_1.requestCallback<QueryFeeSplitResponse>): grpc_1.ClientUnaryCall => {
        ...
        DeployerFeeSplits: GrpcUnaryServiceInterface<QueryDeployerFeeSplitsRequest, QueryDeployerFeeSplitsResponse> = (message: QueryDeployerFeeSplitsRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryDeployerFeeSplitsResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryDeployerFeeSplitsResponse>, callback?: grpc_1.requestCallback<QueryDeployerFeeSplitsResponse>): grpc_1.ClientUnaryCall => {
            return super.DeployerFeeSplits(message, metadata, options, callback);
        };
        WithdrawerFeeSplits: GrpcUnaryServiceInterface<QueryWithdrawerFeeSplitsRequest, QueryWithdrawerFeeSplitsResponse> = (message: QueryWithdrawerFeeSplitsRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<QueryWithdrawerFeeSplitsResponse>, options?: grpc_1.CallOptions | grpc_1.requestCallback<QueryWithdrawerFeeSplitsResponse>, callback?: grpc_1.requestCallback<QueryWithdrawerFeeSplitsResponse>): grpc_1.ClientUnaryCall => {
