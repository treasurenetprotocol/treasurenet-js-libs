...
(function (ethermint) {
    ...
    (function (types) {
        var v1;
        (function (v1) {
            var _EthAccount_one_of_decls;
            class EthAccount extends pb_1.Message {
                constructor(data) {
                    super();
                    _EthAccount_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _EthAccount_one_of_decls, "f"));
            ...
            _EthAccount_one_of_decls = new WeakMap();
