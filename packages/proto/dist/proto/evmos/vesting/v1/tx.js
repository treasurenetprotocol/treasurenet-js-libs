...
(function (evmos) {
    ...
    (function (vesting) {
        var v1;
        (function (v1) {
            var _MsgCreateClawbackVestingAccount_one_of_decls, _MsgCreateClawbackVestingAccountResponse_one_of_decls, _MsgClawback_one_of_decls, _MsgClawbackResponse_one_of_decls;
            class MsgCreateClawbackVestingAccount extends pb_1.Message {
                constructor(data) {
                    super();
                    _MsgCreateClawbackVestingAccount_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [4, 5], __classPrivateFieldGet(this, _MsgCreateClawbackVestingAccount_one_of_decls, "f"));
            ...
            _MsgCreateClawbackVestingAccount_one_of_decls = new WeakMap();
            ...
            class MsgCreateClawbackVestingAccountResponse extends pb_1.Message {
                constructor(data) {
                    super();
                    _MsgCreateClawbackVestingAccountResponse_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _MsgCreateClawbackVestingAccountResponse_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") { }
                }
                static fromObject(data) {
            ...
            _MsgCreateClawbackVestingAccountResponse_one_of_decls = new WeakMap();
            v1.MsgCreateClawbackVestingAccountResponse = MsgCreateClawbackVestingAccountResponse;
            class MsgClawback extends pb_1.Message {
                constructor(data) {
                    super();
                    _MsgClawback_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _MsgClawback_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _MsgClawback_one_of_decls = new WeakMap();
            v1.MsgClawback = MsgClawback;
            class MsgClawbackResponse extends pb_1.Message {
                constructor(data) {
                    super();
                    _MsgClawbackResponse_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _MsgClawbackResponse_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") { }
                }
                static fromObject(data) {
            ...
            _MsgClawbackResponse_one_of_decls = new WeakMap();
            ...
            UnimplementedMsgService.definition = {
                CreateClawbackVestingAccount: {
                    ...
                    requestDeserialize: (bytes) => MsgCreateClawbackVestingAccount.deserialize(new Uint8Array(bytes)),
                    responseSerialize: (message) => Buffer.from(message.serialize()),
                    responseDeserialize: (bytes) => MsgCreateClawbackVestingAccountResponse.deserialize(new Uint8Array(bytes))
                },
                Clawback: {
                    ...
                    responseStream: false,
                    requestSerialize: (message) => Buffer.from(message.serialize()),
                    requestDeserialize: (bytes) => MsgClawback.deserialize(new Uint8Array(bytes)),
                    responseSerialize: (message) => Buffer.from(message.serialize()),
                    responseDeserialize: (bytes) => MsgClawbackResponse.deserialize(new Uint8Array(bytes))
                }
            };
            ...
            class MsgClient extends grpc_1.makeGenericClientConstructor(UnimplementedMsgService.definition, "Msg", {}) {
                constructor(address, credentials, options) {
                    ...
                    this.CreateClawbackVestingAccount = (message, metadata, options, callback) => {
                        return super.CreateClawbackVestingAccount(message, metadata, options, callback);
                    };
                    this.Clawback = (message, metadata, options, callback) => {
