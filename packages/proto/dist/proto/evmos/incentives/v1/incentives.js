...
(function (evmos) {
    ...
    (function (incentives) {
        var v1;
        (function (v1) {
            var _Incentive_one_of_decls, _GasMeter_one_of_decls, _RegisterIncentiveProposal_one_of_decls, _CancelIncentiveProposal_one_of_decls;
            class Incentive extends pb_1.Message {
                constructor(data) {
                    super();
                    _Incentive_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __classPrivateFieldGet(this, _Incentive_one_of_decls, "f"));
            ...
            _Incentive_one_of_decls = new WeakMap();
            v1.Incentive = Incentive;
            class GasMeter extends pb_1.Message {
                constructor(data) {
                    super();
                    _GasMeter_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _GasMeter_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("contract" in data && data.contract != undefined) {
                            this.contract = data.contract;
                        }
            ...
            _GasMeter_one_of_decls = new WeakMap();
            v1.GasMeter = GasMeter;
            class RegisterIncentiveProposal extends pb_1.Message {
                constructor(data) {
                    super();
                    _RegisterIncentiveProposal_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [4], __classPrivateFieldGet(this, _RegisterIncentiveProposal_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _RegisterIncentiveProposal_one_of_decls = new WeakMap();
            v1.RegisterIncentiveProposal = RegisterIncentiveProposal;
            class CancelIncentiveProposal extends pb_1.Message {
                constructor(data) {
                    super();
                    _CancelIncentiveProposal_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _CancelIncentiveProposal_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("title" in data && data.title != undefined) {
                            this.title = data.title;
                        }
            ...
            _CancelIncentiveProposal_one_of_decls = new WeakMap();
