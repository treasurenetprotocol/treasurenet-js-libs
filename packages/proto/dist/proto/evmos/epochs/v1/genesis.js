...
(function (evmos) {
    ...
    (function (epochs) {
        var v1;
        (function (v1) {
            var _EpochInfo_one_of_decls, _GenesisState_one_of_decls;
            class EpochInfo extends pb_1.Message {
                constructor(data) {
                    super();
                    _EpochInfo_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _EpochInfo_one_of_decls, "f"));
            ...
            _EpochInfo_one_of_decls = new WeakMap();
