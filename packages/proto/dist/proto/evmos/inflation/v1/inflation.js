...
(function (evmos) {
    ...
    (function (inflation) {
        var v1;
        (function (v1) {
            var _InflationDistribution_one_of_decls, _ExponentialCalculation_one_of_decls;
            class InflationDistribution extends pb_1.Message {
                constructor(data) {
                    super();
                    _InflationDistribution_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _InflationDistribution_one_of_decls, "f"));
            ...
            _InflationDistribution_one_of_decls = new WeakMap();
            v1.InflationDistribution = InflationDistribution;
            class ExponentialCalculation extends pb_1.Message {
                constructor(data) {
                    super();
                    _ExponentialCalculation_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _ExponentialCalculation_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _ExponentialCalculation_one_of_decls = new WeakMap();
