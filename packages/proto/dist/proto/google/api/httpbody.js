...
(function (google) {
    var api;
    (function (api) {
        var _HttpBody_one_of_decls;
        class HttpBody extends pb_1.Message {
            constructor(data) {
                super();
                _HttpBody_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _HttpBody_one_of_decls, "f"));
        ...
        _HttpBody_one_of_decls = new WeakMap();
