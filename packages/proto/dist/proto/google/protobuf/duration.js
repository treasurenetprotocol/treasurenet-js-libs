...
(function (google) {
    var protobuf;
    (function (protobuf) {
        var _Duration_one_of_decls;
        class Duration extends pb_1.Message {
            constructor(data) {
                super();
                _Duration_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Duration_one_of_decls, "f"));
        ...
        _Duration_one_of_decls = new WeakMap();
