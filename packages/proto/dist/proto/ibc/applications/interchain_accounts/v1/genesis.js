...
(function (ibc) {
    ...
    (function (applications) {
        ...
        (function (interchain_accounts) {
            var v1;
            (function (v1) {
                var _GenesisState_one_of_decls, _ControllerGenesisState_one_of_decls, _HostGenesisState_one_of_decls, _ActiveChannel_one_of_decls, _RegisteredInterchainAccount_one_of_decls;
                ...
                class ControllerGenesisState extends pb_1.Message {
                    constructor(data) {
                        super();
                        _ControllerGenesisState_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1, 2, 3], __classPrivateFieldGet(this, _ControllerGenesisState_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _ControllerGenesisState_one_of_decls = new WeakMap();
                v1.ControllerGenesisState = ControllerGenesisState;
                class HostGenesisState extends pb_1.Message {
                    constructor(data) {
                        super();
                        _HostGenesisState_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1, 2], __classPrivateFieldGet(this, _HostGenesisState_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                            if ("active_channels" in data && data.active_channels != undefined) {
                                this.active_channels = data.active_channels;
                            }
                ...
                _HostGenesisState_one_of_decls = new WeakMap();
                v1.HostGenesisState = HostGenesisState;
                class ActiveChannel extends pb_1.Message {
                    constructor(data) {
                        super();
                        _ActiveChannel_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _ActiveChannel_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _ActiveChannel_one_of_decls = new WeakMap();
                v1.ActiveChannel = ActiveChannel;
                class RegisteredInterchainAccount extends pb_1.Message {
                    constructor(data) {
                        super();
                        _RegisteredInterchainAccount_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _RegisteredInterchainAccount_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                            if ("connection_id" in data && data.connection_id != undefined) {
                                this.connection_id = data.connection_id;
                            }
                ...
                _RegisteredInterchainAccount_one_of_decls = new WeakMap();
