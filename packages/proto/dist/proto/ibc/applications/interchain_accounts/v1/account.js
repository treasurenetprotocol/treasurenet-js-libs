...
(function (ibc) {
    ...
    (function (applications) {
        ...
        (function (interchain_accounts) {
            var v1;
            (function (v1) {
                var _InterchainAccount_one_of_decls;
                class InterchainAccount extends pb_1.Message {
                    constructor(data) {
                        super();
                        _InterchainAccount_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _InterchainAccount_one_of_decls, "f"));
                ...
                _InterchainAccount_one_of_decls = new WeakMap();
