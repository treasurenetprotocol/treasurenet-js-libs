...
(function (ibc) {
    ...
    (function (applications) {
        ...
        (function (interchain_accounts) {
            var v1;
            (function (v1) {
                var _InterchainAccountPacketData_one_of_decls, _CosmosTx_one_of_decls;
                let Type;
                (function (Type) {
                ...
                class InterchainAccountPacketData extends pb_1.Message {
                    constructor(data) {
                        super();
                        _InterchainAccountPacketData_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _InterchainAccountPacketData_one_of_decls, "f"));
                    ...
                    get type() {
                        return pb_1.Message.getFieldWithDefault(this, 1, Type.TYPE_UNSPECIFIED);
                    }
                    set type(value) {
                ...
                _InterchainAccountPacketData_one_of_decls = new WeakMap();
                v1.InterchainAccountPacketData = InterchainAccountPacketData;
                class CosmosTx extends pb_1.Message {
                    constructor(data) {
                        super();
                        _CosmosTx_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _CosmosTx_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _CosmosTx_one_of_decls = new WeakMap();
