...
(function (ibc) {
    ...
    (function (applications) {
        ...
        (function (transfer) {
            var v1;
            (function (v1) {
                var _DenomTrace_one_of_decls, _Params_one_of_decls;
                class DenomTrace extends pb_1.Message {
                    constructor(data) {
                        super();
                        _DenomTrace_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _DenomTrace_one_of_decls, "f"));
                ...
                _DenomTrace_one_of_decls = new WeakMap();
