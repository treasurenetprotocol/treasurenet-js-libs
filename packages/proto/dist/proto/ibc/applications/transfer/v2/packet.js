...
(function (ibc) {
    ...
    (function (applications) {
        ...
        (function (transfer) {
            var v2;
            (function (v2) {
                var _FungibleTokenPacketData_one_of_decls;
                class FungibleTokenPacketData extends pb_1.Message {
                    constructor(data) {
                        super();
                        _FungibleTokenPacketData_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _FungibleTokenPacketData_one_of_decls, "f"));
                ...
                _FungibleTokenPacketData_one_of_decls = new WeakMap();
