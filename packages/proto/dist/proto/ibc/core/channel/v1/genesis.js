...
(function (ibc) {
    ...
    (function (core) {
        ...
        (function (channel) {
            var v1;
            (function (v1) {
                var _GenesisState_one_of_decls, _PacketSequence_one_of_decls;
                class GenesisState extends pb_1.Message {
                    constructor(data) {
                        super();
                        _GenesisState_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1, 2, 3, 4, 5, 6, 7], __classPrivateFieldGet(this, _GenesisState_one_of_decls, "f"));
                ...
                class PacketSequence extends pb_1.Message {
                    constructor(data) {
                        super();
                        _PacketSequence_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _PacketSequence_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _PacketSequence_one_of_decls = new WeakMap();
