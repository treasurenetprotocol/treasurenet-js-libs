...
(function (ibc) {
    ...
    (function (core) {
        ...
        (function (channel) {
            var v1;
            (function (v1) {
                var _Channel_one_of_decls, _IdentifiedChannel_one_of_decls, _Counterparty_one_of_decls, _Packet_one_of_decls, _PacketState_one_of_decls, _Acknowledgement_one_of_decls;
                let State;
                (function (State) {
                ...
                class Channel extends pb_1.Message {
                    constructor(data) {
                        ...
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [4], __classPrivateFieldGet(this, _Channel_one_of_decls, "f"));
                    ...
                    get state() {
                        return pb_1.Message.getFieldWithDefault(this, 1, State.STATE_UNINITIALIZED_UNSPECIFIED);
                    }
                    set state(value) {
                        pb_1.Message.setField(this, 1, value);
                    }
                    get ordering() {
                        return pb_1.Message.getFieldWithDefault(this, 2, Order.ORDER_NONE_UNSPECIFIED);
                    }
                    set ordering(value) {
                ...
                class IdentifiedChannel extends pb_1.Message {
                    constructor(data) {
                        super();
                        _IdentifiedChannel_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [4], __classPrivateFieldGet(this, _IdentifiedChannel_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                            if ("state" in data && data.state != undefined) {
                                this.state = data.state;
                            }
                ...
                _IdentifiedChannel_one_of_decls = new WeakMap();
                ...
                class PacketState extends pb_1.Message {
                    constructor(data) {
                        super();
                        _PacketState_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _PacketState_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                            if ("port_id" in data && data.port_id != undefined) {
                                this.port_id = data.port_id;
                            }
                ...
                _PacketState_one_of_decls = new WeakMap();
                v1.PacketState = PacketState;
                class Acknowledgement extends pb_1.Message {
                    constructor(data) {
                        super();
                        _Acknowledgement_one_of_decls.set(this, [[21, 22]]);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Acknowledgement_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                    ...
                    set result(value) {
                        pb_1.Message.setOneofField(this, 21, __classPrivateFieldGet(this, _Acknowledgement_one_of_decls, "f")[0], value);
                    }
                    get has_result() {
                    ...
                    set error(value) {
                        pb_1.Message.setOneofField(this, 22, __classPrivateFieldGet(this, _Acknowledgement_one_of_decls, "f")[0], value);
                    }
                    get has_error() {
                ...
                _Acknowledgement_one_of_decls = new WeakMap();
