...
(function (ibc) {
    ...
    (function (core) {
        ...
        (function (connection) {
            var v1;
            (function (v1) {
                var _ConnectionEnd_one_of_decls, _IdentifiedConnection_one_of_decls, _Counterparty_one_of_decls, _ClientPaths_one_of_decls, _ConnectionPaths_one_of_decls, _Version_one_of_decls, _Params_one_of_decls;
                let State;
                (function (State) {
                ...
                class ConnectionEnd extends pb_1.Message {
                    constructor(data) {
                        super();
                        _ConnectionEnd_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __classPrivateFieldGet(this, _ConnectionEnd_one_of_decls, "f"));
                    ...
                    get state() {
                        return pb_1.Message.getFieldWithDefault(this, 3, State.STATE_UNINITIALIZED_UNSPECIFIED);
                    }
                    set state(value) {
                ...
                _ConnectionEnd_one_of_decls = new WeakMap();
                v1.ConnectionEnd = ConnectionEnd;
                class IdentifiedConnection extends pb_1.Message {
                    constructor(data) {
                        super();
                        _IdentifiedConnection_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _IdentifiedConnection_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                    ...
                    get state() {
                        return pb_1.Message.getFieldWithDefault(this, 4, State.STATE_UNINITIALIZED_UNSPECIFIED);
                    }
                    set state(value) {
                ...
                _IdentifiedConnection_one_of_decls = new WeakMap();
                v1.IdentifiedConnection = IdentifiedConnection;
                class Counterparty extends pb_1.Message {
                    constructor(data) {
                        super();
                        _Counterparty_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Counterparty_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                            if ("client_id" in data && data.client_id != undefined) {
                                this.client_id = data.client_id;
                            }
                ...
                _Counterparty_one_of_decls = new WeakMap();
                v1.Counterparty = Counterparty;
                class ClientPaths extends pb_1.Message {
                    constructor(data) {
                        super();
                        _ClientPaths_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _ClientPaths_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _ClientPaths_one_of_decls = new WeakMap();
                v1.ClientPaths = ClientPaths;
                class ConnectionPaths extends pb_1.Message {
                    constructor(data) {
                        super();
                        _ConnectionPaths_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __classPrivateFieldGet(this, _ConnectionPaths_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                            if ("client_id" in data && data.client_id != undefined) {
                                this.client_id = data.client_id;
                            }
                ...
                _ConnectionPaths_one_of_decls = new WeakMap();
                v1.ConnectionPaths = ConnectionPaths;
                class Version extends pb_1.Message {
                    constructor(data) {
                        super();
                        _Version_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __classPrivateFieldGet(this, _Version_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
