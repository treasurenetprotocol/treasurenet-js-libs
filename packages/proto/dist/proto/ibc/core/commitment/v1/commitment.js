...
(function (ibc) {
    ...
    (function (core) {
        ...
        (function (commitment) {
            var v1;
            (function (v1) {
                var _MerkleRoot_one_of_decls, _MerklePrefix_one_of_decls, _MerklePath_one_of_decls, _MerkleProof_one_of_decls;
                class MerkleRoot extends pb_1.Message {
                    constructor(data) {
                        super();
                        _MerkleRoot_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _MerkleRoot_one_of_decls, "f"));
                ...
                _MerkleRoot_one_of_decls = new WeakMap();
                v1.MerkleRoot = MerkleRoot;
                class MerklePrefix extends pb_1.Message {
                    constructor(data) {
                        super();
                        _MerklePrefix_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _MerklePrefix_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _MerklePrefix_one_of_decls = new WeakMap();
                v1.MerklePrefix = MerklePrefix;
                class MerklePath extends pb_1.Message {
                    constructor(data) {
                        super();
                        _MerklePath_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _MerklePath_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _MerklePath_one_of_decls = new WeakMap();
                v1.MerklePath = MerklePath;
                class MerkleProof extends pb_1.Message {
                    constructor(data) {
                        super();
                        _MerkleProof_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _MerkleProof_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _MerkleProof_one_of_decls = new WeakMap();
