...
(function (ibc) {
    ...
    (function (lightclients) {
        ...
        (function (tendermint) {
            var v1;
            (function (v1) {
                var _ClientState_one_of_decls, _ConsensusState_one_of_decls, _Misbehaviour_one_of_decls, _Header_one_of_decls, _Fraction_one_of_decls;
                class ClientState extends pb_1.Message {
                    constructor(data) {
                        super();
                        _ClientState_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [8, 9], __classPrivateFieldGet(this, _ClientState_one_of_decls, "f"));
                ...
                class Fraction extends pb_1.Message {
                    constructor(data) {
                        super();
                        _Fraction_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Fraction_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _Fraction_one_of_decls = new WeakMap();
