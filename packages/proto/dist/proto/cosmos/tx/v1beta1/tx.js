...
const dependency_4 = __importStar(require("./../signing/v1beta1/signing"));
...
(function (cosmos) {
    ...
    (function (tx) {
        var v1beta1;
        (function (v1beta1) {
            var _Tx_one_of_decls, _TxRaw_one_of_decls, _SignDoc_one_of_decls, _TxBody_one_of_decls, _AuthInfo_one_of_decls, _SignerInfo_one_of_decls, _ModeInfo_one_of_decls, _Fee_one_of_decls;
            class Tx extends pb_1.Message {
                constructor(data) {
                    super();
                    _Tx_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _Tx_one_of_decls, "f"));
            ...
            _Tx_one_of_decls = new WeakMap();
            v1beta1.Tx = Tx;
            class TxRaw extends pb_1.Message {
                constructor(data) {
                    super();
                    _TxRaw_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _TxRaw_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _TxRaw_one_of_decls = new WeakMap();
            v1beta1.TxRaw = TxRaw;
            class SignDoc extends pb_1.Message {
                constructor(data) {
                    super();
                    _SignDoc_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _SignDoc_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("body_bytes" in data && data.body_bytes != undefined) {
                            this.body_bytes = data.body_bytes;
                        }
            ...
            _SignDoc_one_of_decls = new WeakMap();
            v1beta1.SignDoc = SignDoc;
            class TxBody extends pb_1.Message {
                constructor(data) {
                    super();
                    _TxBody_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1, 1023, 2047], __classPrivateFieldGet(this, _TxBody_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _TxBody_one_of_decls = new WeakMap();
            v1beta1.TxBody = TxBody;
            class AuthInfo extends pb_1.Message {
                constructor(data) {
                    super();
                    _AuthInfo_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _AuthInfo_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _AuthInfo_one_of_decls = new WeakMap();
            v1beta1.AuthInfo = AuthInfo;
            class SignerInfo extends pb_1.Message {
                constructor(data) {
                    super();
                    _SignerInfo_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _SignerInfo_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _SignerInfo_one_of_decls = new WeakMap();
            v1beta1.SignerInfo = SignerInfo;
            class ModeInfo extends pb_1.Message {
                constructor(data) {
                    super();
                    _ModeInfo_one_of_decls.set(this, [[1, 2]]);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _ModeInfo_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                ...
                set single(value) {
                    pb_1.Message.setOneofWrapperField(this, 1, __classPrivateFieldGet(this, _ModeInfo_one_of_decls, "f")[0], value);
                }
                get has_single() {
                    return pb_1.Message.getField(this, 1) != null;
                }
                ...
                set multi(value) {
                    pb_1.Message.setOneofWrapperField(this, 2, __classPrivateFieldGet(this, _ModeInfo_one_of_decls, "f")[0], value);
                }
                get has_multi() {
                    return pb_1.Message.getField(this, 2) != null;
                }
            ...
            _ModeInfo_one_of_decls = new WeakMap();
            v1beta1.ModeInfo = ModeInfo;
            (function (ModeInfo) {
                var _Single_one_of_decls, _Multi_one_of_decls;
                class Single extends pb_1.Message {
                    constructor(data) {
                        super();
                        _Single_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Single_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                    ...
                    get mode() {
                        return pb_1.Message.getFieldWithDefault(this, 1, dependency_4.cosmos.tx.signing.v1beta1.SignMode.SIGN_MODE_UNSPECIFIED);
                    }
                    set mode(value) {
                        pb_1.Message.setField(this, 1, value);
                    }
                ...
                _Single_one_of_decls = new WeakMap();
                ModeInfo.Single = Single;
                class Multi extends pb_1.Message {
                    constructor(data) {
                        super();
                        _Multi_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __classPrivateFieldGet(this, _Multi_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _Multi_one_of_decls = new WeakMap();
                ModeInfo.Multi = Multi;
            })(ModeInfo = v1beta1.ModeInfo || (v1beta1.ModeInfo = {}));
            class Fee extends pb_1.Message {
                constructor(data) {
                    super();
                    _Fee_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _Fee_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
