...
(function (cosmos) {
    ...
    (function (authz) {
        var v1beta1;
        (function (v1beta1) {
            var _EventGrant_one_of_decls, _EventRevoke_one_of_decls;
            class EventGrant extends pb_1.Message {
                constructor(data) {
                    super();
                    _EventGrant_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _EventGrant_one_of_decls, "f"));
            ...
            _EventGrant_one_of_decls = new WeakMap();
            v1beta1.EventGrant = EventGrant;
            class EventRevoke extends pb_1.Message {
                constructor(data) {
                    super();
                    _EventRevoke_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _EventRevoke_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("msg_type_url" in data && data.msg_type_url != undefined) {
                            this.msg_type_url = data.msg_type_url;
                        }
            ...
            _EventRevoke_one_of_decls = new WeakMap();
