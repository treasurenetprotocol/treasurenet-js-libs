...
(function (cosmos) {
    ...
    (function (staking) {
        var v1beta1;
        (function (v1beta1) {
            var _GenesisState_one_of_decls, _LastValidatorPower_one_of_decls;
            class GenesisState extends pb_1.Message {
                constructor(data) {
                    super();
                    _GenesisState_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3, 4, 5, 6, 7], __classPrivateFieldGet(this, _GenesisState_one_of_decls, "f"));
            ...
            class LastValidatorPower extends pb_1.Message {
                constructor(data) {
                    super();
                    _LastValidatorPower_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _LastValidatorPower_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _LastValidatorPower_one_of_decls = new WeakMap();
