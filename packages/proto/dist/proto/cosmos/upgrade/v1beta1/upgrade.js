...
(function (cosmos) {
    ...
    (function (upgrade) {
        var v1beta1;
        (function (v1beta1) {
            var _Plan_one_of_decls, _SoftwareUpgradeProposal_one_of_decls, _CancelSoftwareUpgradeProposal_one_of_decls, _ModuleVersion_one_of_decls;
            class Plan extends pb_1.Message {
                constructor(data) {
                    super();
                    _Plan_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Plan_one_of_decls, "f"));
            ...
            _Plan_one_of_decls = new WeakMap();
            v1beta1.Plan = Plan;
            class SoftwareUpgradeProposal extends pb_1.Message {
                constructor(data) {
                    super();
                    _SoftwareUpgradeProposal_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _SoftwareUpgradeProposal_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _SoftwareUpgradeProposal_one_of_decls = new WeakMap();
            v1beta1.SoftwareUpgradeProposal = SoftwareUpgradeProposal;
            class CancelSoftwareUpgradeProposal extends pb_1.Message {
                constructor(data) {
                    super();
                    _CancelSoftwareUpgradeProposal_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _CancelSoftwareUpgradeProposal_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("title" in data && data.title != undefined) {
                            this.title = data.title;
                        }
            ...
            _CancelSoftwareUpgradeProposal_one_of_decls = new WeakMap();
            v1beta1.CancelSoftwareUpgradeProposal = CancelSoftwareUpgradeProposal;
            class ModuleVersion extends pb_1.Message {
                constructor(data) {
                    super();
                    _ModuleVersion_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _ModuleVersion_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("name" in data && data.name != undefined) {
                            this.name = data.name;
                        }
            ...
            _ModuleVersion_one_of_decls = new WeakMap();
