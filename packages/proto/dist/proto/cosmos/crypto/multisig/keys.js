...
(function (cosmos) {
    ...
    (function (crypto) {
        var multisig;
        (function (multisig) {
            var _LegacyAminoPubKey_one_of_decls;
            class LegacyAminoPubKey extends pb_1.Message {
                constructor(data) {
                    super();
                    _LegacyAminoPubKey_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __classPrivateFieldGet(this, _LegacyAminoPubKey_one_of_decls, "f"));
            ...
            _LegacyAminoPubKey_one_of_decls = new WeakMap();
