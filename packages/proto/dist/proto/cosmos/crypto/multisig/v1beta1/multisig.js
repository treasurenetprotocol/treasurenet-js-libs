...
(function (cosmos) {
    ...
    (function (crypto) {
        ...
        (function (multisig) {
            var v1beta1;
            (function (v1beta1) {
                var _MultiSignature_one_of_decls, _CompactBitArray_one_of_decls;
                class MultiSignature extends pb_1.Message {
                    constructor(data) {
                        super();
                        _MultiSignature_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _MultiSignature_one_of_decls, "f"));
                ...
                _MultiSignature_one_of_decls = new WeakMap();
                v1beta1.MultiSignature = MultiSignature;
                class CompactBitArray extends pb_1.Message {
                    constructor(data) {
                        super();
                        _CompactBitArray_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _CompactBitArray_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _CompactBitArray_one_of_decls = new WeakMap();
