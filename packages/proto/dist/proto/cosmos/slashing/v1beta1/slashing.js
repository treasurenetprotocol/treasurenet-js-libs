...
(function (cosmos) {
    ...
    (function (slashing) {
        var v1beta1;
        (function (v1beta1) {
            var _ValidatorSigningInfo_one_of_decls, _Params_one_of_decls;
            class ValidatorSigningInfo extends pb_1.Message {
                constructor(data) {
                    super();
                    _ValidatorSigningInfo_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _ValidatorSigningInfo_one_of_decls, "f"));
            ...
            _ValidatorSigningInfo_one_of_decls = new WeakMap();
