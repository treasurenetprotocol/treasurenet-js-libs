...
(function (cosmos) {
    ...
    (function (capability) {
        var v1beta1;
        (function (v1beta1) {
            var _GenesisOwners_one_of_decls, _GenesisState_one_of_decls;
            class GenesisOwners extends pb_1.Message {
                constructor(data) {
                    super();
                    _GenesisOwners_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _GenesisOwners_one_of_decls, "f"));
            ...
            _GenesisOwners_one_of_decls = new WeakMap();
