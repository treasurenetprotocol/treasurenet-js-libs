...
(function (cosmos) {
    ...
    (function (capability) {
        var v1beta1;
        (function (v1beta1) {
            var _Capability_one_of_decls, _Owner_one_of_decls, _CapabilityOwners_one_of_decls;
            class Capability extends pb_1.Message {
                constructor(data) {
                    super();
                    _Capability_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Capability_one_of_decls, "f"));
            ...
            _Capability_one_of_decls = new WeakMap();
            v1beta1.Capability = Capability;
            class Owner extends pb_1.Message {
                constructor(data) {
                    super();
                    _Owner_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Owner_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _Owner_one_of_decls = new WeakMap();
            v1beta1.Owner = Owner;
            class CapabilityOwners extends pb_1.Message {
                constructor(data) {
                    super();
                    _CapabilityOwners_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _CapabilityOwners_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _CapabilityOwners_one_of_decls = new WeakMap();
