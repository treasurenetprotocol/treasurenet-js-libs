...
(function (cosmos) {
    ...
    (function (bank) {
        var v1beta1;
        (function (v1beta1) {
            var _SendAuthorization_one_of_decls;
            class SendAuthorization extends pb_1.Message {
                constructor(data) {
                    super();
                    _SendAuthorization_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _SendAuthorization_one_of_decls, "f"));
            ...
            _SendAuthorization_one_of_decls = new WeakMap();
