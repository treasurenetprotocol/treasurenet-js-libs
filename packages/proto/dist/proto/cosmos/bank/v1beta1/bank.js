...
(function (cosmos) {
    ...
    (function (bank) {
        var v1beta1;
        (function (v1beta1) {
            var _Params_one_of_decls, _SendEnabled_one_of_decls, _Input_one_of_decls, _Output_one_of_decls, _Supply_one_of_decls, _DenomUnit_one_of_decls, _Metadata_one_of_decls;
            ...
            class SendEnabled extends pb_1.Message {
                constructor(data) {
                    super();
                    _SendEnabled_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _SendEnabled_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _SendEnabled_one_of_decls = new WeakMap();
            v1beta1.SendEnabled = SendEnabled;
            class Input extends pb_1.Message {
                constructor(data) {
                    super();
                    _Input_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __classPrivateFieldGet(this, _Input_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            class Output extends pb_1.Message {
                constructor(data) {
                    ...
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __classPrivateFieldGet(this, _Output_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("address" in data && data.address != undefined) {
                            this.address = data.address;
                        }
            ...
            class Supply extends pb_1.Message {
                constructor(data) {
                    super();
                    _Supply_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _Supply_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _Supply_one_of_decls = new WeakMap();
            v1beta1.Supply = Supply;
            class DenomUnit extends pb_1.Message {
                constructor(data) {
                    super();
                    _DenomUnit_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _DenomUnit_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("denom" in data && data.denom != undefined) {
                            this.denom = data.denom;
                        }
            ...
            _DenomUnit_one_of_decls = new WeakMap();
            v1beta1.DenomUnit = DenomUnit;
            class Metadata extends pb_1.Message {
                constructor(data) {
                    super();
                    _Metadata_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __classPrivateFieldGet(this, _Metadata_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
