...
(function (cosmos) {
    ...
    (function (auth) {
        var v1beta1;
        (function (v1beta1) {
            var _BaseAccount_one_of_decls, _ModuleAccount_one_of_decls, _Params_one_of_decls;
            class BaseAccount extends pb_1.Message {
                constructor(data) {
                    super();
                    _BaseAccount_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _BaseAccount_one_of_decls, "f"));
            ...
            _BaseAccount_one_of_decls = new WeakMap();
            v1beta1.BaseAccount = BaseAccount;
            class ModuleAccount extends pb_1.Message {
                constructor(data) {
                    super();
                    _ModuleAccount_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _ModuleAccount_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _ModuleAccount_one_of_decls = new WeakMap();
