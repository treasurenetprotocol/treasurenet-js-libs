...
(function (cosmos) {
    ...
    (function (feegrant) {
        var v1beta1;
        (function (v1beta1) {
            var _BasicAllowance_one_of_decls, _PeriodicAllowance_one_of_decls, _AllowedMsgAllowance_one_of_decls, _Grant_one_of_decls;
            class BasicAllowance extends pb_1.Message {
                constructor(data) {
                    super();
                    _BasicAllowance_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _BasicAllowance_one_of_decls, "f"));
            ...
            _BasicAllowance_one_of_decls = new WeakMap();
            v1beta1.BasicAllowance = BasicAllowance;
            class PeriodicAllowance extends pb_1.Message {
                constructor(data) {
                    super();
                    _PeriodicAllowance_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3, 4], __classPrivateFieldGet(this, _PeriodicAllowance_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _PeriodicAllowance_one_of_decls = new WeakMap();
            v1beta1.PeriodicAllowance = PeriodicAllowance;
            class AllowedMsgAllowance extends pb_1.Message {
                constructor(data) {
                    super();
                    _AllowedMsgAllowance_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [2], __classPrivateFieldGet(this, _AllowedMsgAllowance_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _AllowedMsgAllowance_one_of_decls = new WeakMap();
