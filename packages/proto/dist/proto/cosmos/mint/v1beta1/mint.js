...
(function (cosmos) {
    ...
    (function (mint) {
        var v1beta1;
        (function (v1beta1) {
            var _Minter_one_of_decls, _Params_one_of_decls;
            class Minter extends pb_1.Message {
                constructor(data) {
                    super();
                    _Minter_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Minter_one_of_decls, "f"));
            ...
            _Minter_one_of_decls = new WeakMap();
