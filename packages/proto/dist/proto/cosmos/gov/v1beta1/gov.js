...
(function (cosmos) {
    ...
    (function (gov) {
        var v1beta1;
        (function (v1beta1) {
            var _WeightedVoteOption_one_of_decls, _TextProposal_one_of_decls, _Deposit_one_of_decls, _Proposal_one_of_decls, _TallyResult_one_of_decls, _Vote_one_of_decls, _DepositParams_one_of_decls, _VotingParams_one_of_decls, _TallyParams_one_of_decls;
            let VoteOption;
            (function (VoteOption) {
            ...
            class WeightedVoteOption extends pb_1.Message {
                constructor(data) {
                    super();
                    _WeightedVoteOption_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _WeightedVoteOption_one_of_decls, "f"));
                ...
                get option() {
                    return pb_1.Message.getFieldWithDefault(this, 1, VoteOption.VOTE_OPTION_UNSPECIFIED);
                }
                set option(value) {
            ...
            _WeightedVoteOption_one_of_decls = new WeakMap();
            v1beta1.WeightedVoteOption = WeightedVoteOption;
            class TextProposal extends pb_1.Message {
                constructor(data) {
                    super();
                    _TextProposal_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _TextProposal_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _TextProposal_one_of_decls = new WeakMap();
            v1beta1.TextProposal = TextProposal;
            class Deposit extends pb_1.Message {
                constructor(data) {
                    super();
                    _Deposit_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _Deposit_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _Deposit_one_of_decls = new WeakMap();
            v1beta1.Deposit = Deposit;
            class Proposal extends pb_1.Message {
                constructor(data) {
                    super();
                    _Proposal_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [7], __classPrivateFieldGet(this, _Proposal_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("proposal_id" in data && data.proposal_id != undefined) {
                            this.proposal_id = data.proposal_id;
                        }
                ...
                get status() {
                    return pb_1.Message.getFieldWithDefault(this, 3, ProposalStatus.PROPOSAL_STATUS_UNSPECIFIED);
                }
                set status(value) {
            ...
            class TallyResult extends pb_1.Message {
                constructor(data) {
                    super();
                    _TallyResult_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _TallyResult_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _TallyResult_one_of_decls = new WeakMap();
            v1beta1.TallyResult = TallyResult;
            class Vote extends pb_1.Message {
                constructor(data) {
                    super();
                    _Vote_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [4], __classPrivateFieldGet(this, _Vote_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("proposal_id" in data && data.proposal_id != undefined) {
                            this.proposal_id = data.proposal_id;
                        }
                ...
                get option() {
                    return pb_1.Message.getFieldWithDefault(this, 3, VoteOption.VOTE_OPTION_UNSPECIFIED);
                }
                set option(value) {
                    pb_1.Message.setField(this, 3, value);
                }
            ...
            class DepositParams extends pb_1.Message {
                constructor(data) {
                    super();
                    _DepositParams_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _DepositParams_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _DepositParams_one_of_decls = new WeakMap();
            v1beta1.DepositParams = DepositParams;
            class VotingParams extends pb_1.Message {
                constructor(data) {
                    super();
                    _VotingParams_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _VotingParams_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _VotingParams_one_of_decls = new WeakMap();
            v1beta1.VotingParams = VotingParams;
            class TallyParams extends pb_1.Message {
                constructor(data) {
                    super();
                    _TallyParams_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _TallyParams_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _TallyParams_one_of_decls = new WeakMap();
