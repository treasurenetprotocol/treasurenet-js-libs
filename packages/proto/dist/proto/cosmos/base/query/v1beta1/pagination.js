...
(function (cosmos) {
    ...
    (function (base) {
        ...
        (function (query) {
            var v1beta1;
            (function (v1beta1) {
                var _PageRequest_one_of_decls, _PageResponse_one_of_decls;
                class PageRequest extends pb_1.Message {
                    constructor(data) {
                        super();
                        _PageRequest_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _PageRequest_one_of_decls, "f"));
                ...
                _PageRequest_one_of_decls = new WeakMap();
                v1beta1.PageRequest = PageRequest;
                class PageResponse extends pb_1.Message {
                    constructor(data) {
                        super();
                        _PageResponse_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _PageResponse_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _PageResponse_one_of_decls = new WeakMap();
