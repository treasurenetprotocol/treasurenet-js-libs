...
(function (cosmos) {
    ...
    (function (base) {
        ...
        (function (snapshots) {
            var v1beta1;
            (function (v1beta1) {
                var _Snapshot_one_of_decls, _Metadata_one_of_decls, _SnapshotItem_one_of_decls, _SnapshotStoreItem_one_of_decls, _SnapshotIAVLItem_one_of_decls, _SnapshotExtensionMeta_one_of_decls, _SnapshotExtensionPayload_one_of_decls;
                ...
                class Metadata extends pb_1.Message {
                    constructor(data) {
                        ...
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _Metadata_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                class SnapshotItem extends pb_1.Message {
                    constructor(data) {
                        super();
                        _SnapshotItem_one_of_decls.set(this, [[1, 2, 3, 4]]);
                    ...
                    set extension(value) {
                        pb_1.Message.setOneofWrapperField(this, 3, __classPrivateFieldGet(this, _SnapshotItem_one_of_decls, "f")[0], value);
                    }
                    get has_extension() {
                    ...
                    set extension_payload(value) {
                        pb_1.Message.setOneofWrapperField(this, 4, __classPrivateFieldGet(this, _SnapshotItem_one_of_decls, "f")[0], value);
                    }
                ...
                class SnapshotExtensionMeta extends pb_1.Message {
                    constructor(data) {
                        super();
                        _SnapshotExtensionMeta_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _SnapshotExtensionMeta_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                            if ("name" in data && data.name != undefined) {
                                this.name = data.name;
                            }
                ...
                _SnapshotExtensionMeta_one_of_decls = new WeakMap();
                v1beta1.SnapshotExtensionMeta = SnapshotExtensionMeta;
                class SnapshotExtensionPayload extends pb_1.Message {
                    constructor(data) {
                        super();
                        _SnapshotExtensionPayload_one_of_decls.set(this, []);
                        pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _SnapshotExtensionPayload_one_of_decls, "f"));
                        if (!Array.isArray(data) && typeof data == "object") {
                ...
                _SnapshotExtensionPayload_one_of_decls = new WeakMap();
