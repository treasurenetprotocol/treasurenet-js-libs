...
(function (cosmos) {
    ...
    (function (base) {
        var v1beta1;
        (function (v1beta1) {
            var _Coin_one_of_decls, _DecCoin_one_of_decls, _IntProto_one_of_decls, _DecProto_one_of_decls;
            class Coin extends pb_1.Message {
                constructor(data) {
                    super();
                    _Coin_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _Coin_one_of_decls, "f"));
            ...
            _Coin_one_of_decls = new WeakMap();
            v1beta1.Coin = Coin;
            class DecCoin extends pb_1.Message {
                constructor(data) {
                    super();
                    _DecCoin_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _DecCoin_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
                        if ("denom" in data && data.denom != undefined) {
                            this.denom = data.denom;
                        }
            ...
            _DecCoin_one_of_decls = new WeakMap();
            v1beta1.DecCoin = DecCoin;
            class IntProto extends pb_1.Message {
                constructor(data) {
                    super();
                    _IntProto_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _IntProto_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _IntProto_one_of_decls = new WeakMap();
            v1beta1.IntProto = IntProto;
            class DecProto extends pb_1.Message {
                constructor(data) {
                    super();
                    _DecProto_one_of_decls.set(this, []);
                    pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _DecProto_one_of_decls, "f"));
                    if (!Array.isArray(data) && typeof data == "object") {
            ...
            _DecProto_one_of_decls = new WeakMap();
