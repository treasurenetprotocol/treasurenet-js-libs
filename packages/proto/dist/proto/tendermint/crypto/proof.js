...
(function (tendermint) {
    var crypto;
    (function (crypto) {
        var _Proof_one_of_decls, _ValueOp_one_of_decls, _DominoOp_one_of_decls, _ProofOp_one_of_decls, _ProofOps_one_of_decls;
        class Proof extends pb_1.Message {
            constructor(data) {
                super();
                _Proof_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [4], __classPrivateFieldGet(this, _Proof_one_of_decls, "f"));
        ...
        _Proof_one_of_decls = new WeakMap();
        crypto.Proof = Proof;
        class ValueOp extends pb_1.Message {
            constructor(data) {
                super();
                _ValueOp_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _ValueOp_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
        ...
        _ValueOp_one_of_decls = new WeakMap();
        crypto.ValueOp = ValueOp;
        class DominoOp extends pb_1.Message {
            constructor(data) {
                super();
                _DominoOp_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _DominoOp_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
                    if ("key" in data && data.key != undefined) {
                        this.key = data.key;
                    }
        ...
        _DominoOp_one_of_decls = new WeakMap();
        crypto.DominoOp = DominoOp;
        class ProofOp extends pb_1.Message {
            constructor(data) {
                super();
                _ProofOp_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _ProofOp_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
        ...
        _ProofOp_one_of_decls = new WeakMap();
        crypto.ProofOp = ProofOp;
        class ProofOps extends pb_1.Message {
            constructor(data) {
                super();
                _ProofOps_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _ProofOps_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
        ...
        _ProofOps_one_of_decls = new WeakMap();
