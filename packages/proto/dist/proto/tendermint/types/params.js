...
(function (tendermint) {
    var types;
    (function (types) {
        var _ConsensusParams_one_of_decls, _BlockParams_one_of_decls, _EvidenceParams_one_of_decls, _ValidatorParams_one_of_decls, _VersionParams_one_of_decls, _HashedParams_one_of_decls;
        ...
        class EvidenceParams extends pb_1.Message {
            constructor(data) {
                super();
                _EvidenceParams_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _EvidenceParams_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
        ...
        _EvidenceParams_one_of_decls = new WeakMap();
        types.EvidenceParams = EvidenceParams;
        class ValidatorParams extends pb_1.Message {
            constructor(data) {
                super();
                _ValidatorParams_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _ValidatorParams_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
        ...
        _ValidatorParams_one_of_decls = new WeakMap();
        types.ValidatorParams = ValidatorParams;
        class VersionParams extends pb_1.Message {
            constructor(data) {
                super();
                _VersionParams_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _VersionParams_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
        ...
        _VersionParams_one_of_decls = new WeakMap();
        types.VersionParams = VersionParams;
        class HashedParams extends pb_1.Message {
            constructor(data) {
                super();
                _HashedParams_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _HashedParams_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
        ...
        _HashedParams_one_of_decls = new WeakMap();
