...
(function (tendermint) {
    var types;
    (function (types) {
        var _Evidence_one_of_decls, _DuplicateVoteEvidence_one_of_decls, _LightClientAttackEvidence_one_of_decls, _EvidenceList_one_of_decls;
        class Evidence extends pb_1.Message {
            constructor(data) {
                super();
                _Evidence_one_of_decls.set(this, [[1, 2]]);
            ...
            set duplicate_vote_evidence(value) {
                pb_1.Message.setOneofWrapperField(this, 1, __classPrivateFieldGet(this, _Evidence_one_of_decls, "f")[0], value);
            }
            ...
            set light_client_attack_evidence(value) {
                pb_1.Message.setOneofWrapperField(this, 2, __classPrivateFieldGet(this, _Evidence_one_of_decls, "f")[0], value);
            }
        ...
        class DuplicateVoteEvidence extends pb_1.Message {
            constructor(data) {
                super();
                _DuplicateVoteEvidence_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], __classPrivateFieldGet(this, _DuplicateVoteEvidence_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
        ...
        _DuplicateVoteEvidence_one_of_decls = new WeakMap();
        types.DuplicateVoteEvidence = DuplicateVoteEvidence;
        class LightClientAttackEvidence extends pb_1.Message {
            constructor(data) {
                super();
                _LightClientAttackEvidence_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [3], __classPrivateFieldGet(this, _LightClientAttackEvidence_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
        ...
        _LightClientAttackEvidence_one_of_decls = new WeakMap();
        types.LightClientAttackEvidence = LightClientAttackEvidence;
        class EvidenceList extends pb_1.Message {
            constructor(data) {
                super();
                _EvidenceList_one_of_decls.set(this, []);
                pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], __classPrivateFieldGet(this, _EvidenceList_one_of_decls, "f"));
                if (!Array.isArray(data) && typeof data == "object") {
        ...
        _EvidenceList_one_of_decls = new WeakMap();
